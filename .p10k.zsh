# Generated by Powerlevel10k configuration wizard on 2021-11-09 at 18:19 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='%F{white} %F{green}❯'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%F{white} %F{red}❯'
  # Prompt symbol in command vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_CONTENT_EXPANSION='%F{white} %F{green}❮'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_CONTENT_EXPANSION='%F{white} %F{red}❮'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_CONTENT_EXPANSION='%F{white} %F{green}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_CONTENT_EXPANSION='%F{white} %F{red}'
  # Prompt symbol in overwrite vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIOWR_CONTENT_EXPANSION='%F{white} %F{green}'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIOWR_CONTENT_EXPANSION='%F{white} %F{red}'
  ...
  # --- Make the current directory appear in bold ---
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # If local branch name is at most 48 characters long, show it in full.
      # Otherwise show the first 12 … the last 12.
      # Tip: To always show local branch name in full without truncation, delete the next line.
      (( $#branch > 42 )) && branch[19,-19]="…"  # <-- this line
  ...
  # ---> Here I've made the git branch show up in bold
  typeset -g POWERLEVEL9K_VCS_CONTENT_EXPANSION='%5F%B${$((my_git_formatter(1)))+${my_git_format}}%b'
  typeset -g POWERLEVEL9K_VCS_LOADING_CONTENT_EXPANSION='%5F%B${$((my_git_formatter(0)))+${my_git_format}}%b'
  # Enable counters for staged, unstaged, etc.
  # ---> Edit this line to ...=-1 to re-enable counters
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_PREFIX='%F{white}noodling '
  # P9K_CONTENT is what you normally see without expansion
  typeset -g POWERLEVEL9K_VIRTUALENV_CONTENT_EXPANSION='%B${P9K_CONTENT}%b'

  #####################[ anaconda: conda environment (https://conda.io/) ]######################
  # Anaconda environment color.
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=2
  typeset -g POWERLEVEL9K_ANACONDA_PREFIX='%fon '
  ...
  # is empty.
  # typeset -g POWERLEVEL9K_ANACONDA_PREFIX= 'on '
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='%B${${${${CONDA_PROMPT_MODIFIER#\(}% }%\)}:-${CONDA_PREFIX:t}}%b'
  # typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='%B${P9K_CONTENT}%b'

  # Custom icon.
  typeset -g POWERLEVEL9K_ANACONDA_VISUAL_IDENTIFIER_EXPANSION='%F{green}'
  ...
  typeset -g POWERLEVEL9K_PYENV_PREFIX='%F{white}on '
  typeset -g POWERLEVEL9K_PYENV_CONTENT_EXPANSION='%B${P9K_CONTENT}${${P9K_CONTENT:#$P9K_PYENV_PYTHON_VERSION(|/*)}:+ $P9K_PYENV_PYTHON_VERSION}%b'
  ...
  typeset -g POWERLEVEL9K_NODE_VERSION_PREFIX='%F{white}on '
  ...
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='%B${P9K_GCLOUD_PROJECT_NAME//\%/%%}%b'
  # typeset -g POWERLEVEL9K_VIRTUALENV_CONTENT_EXPANSION='%B${P9K_CONTENT}%b'
  ...
  function prompt_vim_mode() {
      ...
      p10k segment -f 7 -i ${icon}
  }

  function instant_prompt_vim_mode() {
      prompt_vim_mode
  }

  function prompt_intel_arm_arch() {
      if [[ "$(arch)" = "i386" ]]; then
          indicator='x86'
      else
          indicator='arm'
      fi
      p10k segment -f 7 -i ${indicator}
  }

  function instant_prompt_intel_arm_arch() {
    prompt_intel_arm_arch
  }
